...
void MnistDataloader::read_images_labels(std::string input_image_filename, std::string input_label_filename, std::vector<uint16_t> &labels, std::vector<std::vector<std::vector<uint8_t>>> &images)
{
...
void MnistDataloader::read_images_labels(std::vector<uint16_t> &labels, std::vector<std::vector<std::vector<uint8_t>>> &images)
{
    this->read_images_labels("", "", labels, images);
}
